...
public class GeofenceRequester
    ...
    public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) {
        ...
        if (LocationStatusCodes.SUCCESS == statusCode) {
            ...
            Log.d(Utilities.APPTAG, msg);

            // Create an Intent to broadcast to the app
            broadcastIntent.setAction(Utilities.ACTION_GEOFENCES_ADDED)
                           .addCategory(Utilities.CATEGORY_LOCATION_SERVICES)
                           .putExtra(Utilities.EXTRA_GEOFENCE_STATUS, msg);
    ...
    public void onConnected(Bundle arg0) {
        ...
        Log.d(Utilities.APPTAG, mActivity.getString(R.string.connected));
    ...
    public void onDisconnected() {
        ...
        Log.d(Utilities.APPTAG, mActivity.getString(R.string.disconnected));
    ...
    private PendingIntent createRequestPendingIntent() {
        ...
        // If no PendingIntent exists
            ...
            Intent intent = new Intent(mActivity, ContextUpdateService.class);
            /*
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
         ...
         */
            ...
            Intent errorBroadcastIntent = new Intent(Utilities.ACTION_CONNECTION_ERROR);
            errorBroadcastIntent.addCategory(Utilities.CATEGORY_LOCATION_SERVICES)
                                .putExtra(Utilities.EXTRA_CONNECTION_ERROR_CODE,
