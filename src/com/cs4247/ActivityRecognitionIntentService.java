...
public class ActivityRecognitionIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            Log.e(Utilities.APPTAG, getString(R.string.date_format_error));
        }
        ...
        if (ActivityRecognitionResult.hasResult(intent)) {
            ...
            if (!mPrefs.contains(Utilities.KEY_PREVIOUS_ACTIVITY_TYPE)) {

                // This is the first type an activity has been detected. Store the type
                Editor editor = mPrefs.edit();
                editor.putInt(Utilities.KEY_PREVIOUS_ACTIVITY_TYPE, activityType);
                editor.commit();
    ...
    private boolean activityChanged(int currentType) {
        ...
        int previousType = mPrefs.getInt(Utilities.KEY_PREVIOUS_ACTIVITY_TYPE,
