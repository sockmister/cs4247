 ...
 *
 */
public class ActivityRecognitionRequester
    ...
    private void continueRequestActivityUpdates() {
        ...
        getActivityRecognitionClient().requestActivityUpdates(
                Utilities.DETECTION_INTERVAL_MILLISECONDS,
    ...
    public void onConnected(Bundle arg0) {
        ...
        Log.d(Utilities.APPTAG, mContext.getString(R.string.connected));
    ...
    public void onDisconnected() {
        ...
        Log.d(Utilities.APPTAG, mContext.getString(R.string.disconnected));
